...
export class Constants {
    ...
    static readonly GLOBAL_PROJECT = process.env.PWG_ENV_PROJECT;
    ...
    static readonly GLOBAL_RP_ENDPOINT: string = 'https://reportportal.10339.elluciancloud.com/api/v1';
    static readonly GLOBAL_RP_TOKEN: string = '8c086d5c-74ba-4c75-a114-d8f5a67fa3ab';
